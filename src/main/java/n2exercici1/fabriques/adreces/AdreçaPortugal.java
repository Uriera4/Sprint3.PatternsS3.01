...
public class AdreçaPortugal extends DefaultAdreça implements Adreça {


    public AdreçaPortugal(String carrer, int numero, String ciutat, String codiPostal, String pais) {
