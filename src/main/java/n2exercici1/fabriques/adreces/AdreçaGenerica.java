...
public class AdreçaGenerica extends DefaultAdreça implements Adreça{

    public AdreçaGenerica(String carrer, int numero, String ciutat, String codiPostal, String pais) {
